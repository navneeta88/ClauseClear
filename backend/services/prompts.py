...
- Describe only what the document says. Do not add what is typical, customary or required by law.
"""
...
- why_it_matters: 1-3 plain-English sentences describing what the clause requires or allows and its practical effect, based only on this document's own words. Never say what is typical, usual, normal or customary, what the law requires, or what a party would normally do. Do not compare the clause with outside standards. Use neutral wording such as "This clause requires..." or "This clause allows...". Never say "do not sign" and never give advice.
